...
export const About = () => {
    ...
    useEffect(() => {
        ...
        const el2 = aboutTedxNitj.current;
        const el3 = aboutTedx.current;
        gsap.fromTo(el, {opacity : 0}, {opacity : 1, duration: 2, scrollTrigger : {
            trigger: el,
            
        }})
        gsap.fromTo(el2, {opacity : 0}, {opacity : 1, duration: 2, scrollTrigger : {
            trigger: el2
        }})
        gsap.fromTo(el3, {opacity : 0}, {opacity : 1, duration: 2, scrollTrigger : {
            trigger: el3
        }})
    },[])
    return (
        <div className="about__page">
            ...
            <div className="about">
                <div className='about__blocks'> 
                    <div className='about__ted' ref={aboutTed}>
                    ...
                    <div className='about__ted' ref={aboutTedx}>
                    ...
                    <div className='about__ted' ref={aboutTedxNitj}>
